...
//const INGREDIENT_PRICES = { moved to redur.js after redux implementation
//        salad: .5,
//        cheese: .4,
//        meat: 1.3,
//        bacon: 0.7
...
//        purchasable: false,
    ...
    componentDidMount () {
//        axios.get('https://react-my-burger-89734.firebaseio.com/ingredients.json') //removed as using redux now
//            .then(response => {
